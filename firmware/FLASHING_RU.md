...
3. Один раз выберите образ прошивки и укажите для него адрес `0x000000`.
   ...
   ![Flash Download Tool: сначала ERASE (1), затем START (2)](flash_download_tool.png)

4. Установите перемычку J2, подключите плату к компьютеру через
   USB-UART-конвертер, затем переведите ESP в режим программирования кнопками
   **SW1 + SW2** по инструкции выше.
5. Нажмите **ERASE**, чтобы стереть содержимое flash-памяти.
6. Нажмите **Start**, чтобы записать образ прошивки.
7. Дождитесь надписи **FINISH**, снимите перемычку J2, перезапустите плату и
